...
namespace MainEmp
{
    public class Emp
    {
        ...
        public Emp(string firstName, string lastName, double monthlySalary)
        {
    ...
    public class PermanentEmp : Emp
    {
        ...
        string _joiningDate; string _retirementDate;

        public PermanentEmp(string firstName, string lastName, string joiningDate, string retirementDate, double monthlySalary, double housingRentAllowance, double dearnessAllowance, double providentFund) : base(firstName, lastName, monthlySalary)
        {
